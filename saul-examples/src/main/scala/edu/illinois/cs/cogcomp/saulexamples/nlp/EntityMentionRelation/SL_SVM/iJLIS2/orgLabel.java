...
public class orgLabel extends Classifier
{
    ...
    public String getInputType() { return "ml.wolfe.examples.parisa.iJLIS2.ConllRawToken"; }
    ...
    public String discreteValue(Object __example)
    {
        if (!(__example instanceof ConllRawToken))
        {
            ...
            System.err.println("Classifier 'orgLabel(ConllRawToken)' defined on line 66 of LALModel.lbj received '" + type + "' as input.");
        ...
        {
            System.err.println("Classifier 'orgLabel' defined on line 66 of LALModel.lbj produced '" + __cachedValue  + "' as a feature value, which is not allowable.");
            System.exit(1);
        }
