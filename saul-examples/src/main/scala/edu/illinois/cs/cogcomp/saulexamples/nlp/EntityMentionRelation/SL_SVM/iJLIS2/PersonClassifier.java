...
// 
...
public class PersonClassifier extends SparseAveragedPerceptron
{
  ...
  static
  {
    ...
    _lexFilePath = PersonClassifier.class.getResource("PersonClassifier.ex");
  ...
  private static void loadInstance()
  {
    if (instance == null)
    {
      instance = (PersonClassifier) readLearner(_lcFilePath);
  ...
  {
    super("ml.wolfe.examples.parisa.iJLIS2.PersonClassifier");
    isClone = true;
  }
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof ConllRawToken || example instanceof Object[]))
      {
        ...
        System.err.println("Classifier 'PersonClassifier(ConllRawToken)' defined on line 27 of LALModel.lbj received '" + type + "' as input.");
  ...
  public static void main(String[] args)
  {
    ...
    {
      System.err.println("usage: ml.wolfe.examples.parisa.iJLIS2.PersonClassifier \\");
