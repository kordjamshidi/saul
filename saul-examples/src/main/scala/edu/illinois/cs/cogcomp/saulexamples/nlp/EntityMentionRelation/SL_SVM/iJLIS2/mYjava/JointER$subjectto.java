...
public class JointER$subjectto extends ParameterizedConstraint
{
  ...
  public JointER$subjectto() { super("JointER$subjectto"); }
  ...
  public String discreteValue(Object __example)
  {
    if (!(__example instanceof ConllRelation))
    {
      ...
      System.err.println("Constraint 'JointER$subjectto(ConllRelation)' defined on line 29 of ER_Joint.lbj received '" + type + "' as input.");
  ...
  public FeatureVector[] classify(Object[] examples)
  {
    if (!(examples instanceof ConllRelation[]))
    {
      ...
      System.err.println("Classifier 'JointER$subjectto(ConllRelation)' defined on line 29 of ER_Joint.lbj received '" + type + "' as input.");
      new Exception().printStackTrace();
      System.exit(1);
    }
