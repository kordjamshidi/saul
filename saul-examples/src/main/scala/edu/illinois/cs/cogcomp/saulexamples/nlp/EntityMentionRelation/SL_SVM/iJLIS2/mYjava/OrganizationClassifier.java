...
// 
...
import edu.illinois.cs.cogcomp.saulexamples.nlp.EntityMentionRelation.SL_SVM.iJLIS2.orgLabel;
...
public class OrganizationClassifier extends SparseAveragedPerceptron
{
  ...
  static
  {
    ...
    _lexFilePath = OrganizationClassifier.class.getResource("OrganizationClassifier.lex");
  ...
  private static void loadInstance()
  {
    if (instance == null)
    {
      instance = (OrganizationClassifier) Learner.readLearner(_lcFilePath);
      instance.readLexiconOnDemand(_lexFilePath);
    }
  }

  public static Parser getParser() { return new edu.illinois.cs.cogcomp.lbjava.parse.ArrayFileParser("/home/kordjam/Downloads/mylbjtest/src/main/java/OrganizationClassifier.ex"); }
  public static Parser getTestParser() { return new edu.illinois.cs.cogcomp.lbjava.parse.ArrayFileParser("/home/kordjam/Downloads/mylbjtest/src/main/java/OrganizationClassifier.test.ex"); }
  ...
  public OrganizationClassifier()
  {
	...
	public OrganizationClassifier(Parameters p, String modelPath, String lexiconPath) {
		...
		else if (IOUtilities.existsInClasspath(OrganizationClassifier.class, modelPath)) {
			readModel(IOUtilities.loadFromClasspath(OrganizationClassifier.class, modelPath));
			readLexiconOnDemand(IOUtilities.loadFromClasspath(OrganizationClassifier.class, lexiconPath));
		}
		else {
			containingPackage = "";
			name = "OrganizationClassifier";
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof ConllRawToken || example instanceof Object[]))
      {
        ...
        System.err.println("Classifier 'OrganizationClassifier(ConllRawToken)' defined on line 72 of LALModel.lbj received '" + type + "' as input.");
  ...
  public static void main(String[] args)
  {
    ...
    {
      System.err.println("usage: OrganizationClassifier \\");
