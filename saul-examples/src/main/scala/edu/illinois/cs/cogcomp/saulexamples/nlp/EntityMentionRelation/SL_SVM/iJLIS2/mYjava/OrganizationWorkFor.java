...
public class OrganizationWorkFor extends ParameterizedConstraint
{
  ...
  public OrganizationWorkFor() { super("OrganizationWorkFor"); }
  ...
  public String discreteValue(Object __example)
  {
    if (!(__example instanceof ConllRelation))
    {
      ...
      System.err.println("Constraint 'OrganizationWorkFor(ConllRelation)' defined on line 20 of ER_Joint.lbj received '" + type + "' as input.");
  ...
  public FeatureVector[] classify(Object[] examples)
  {
    if (!(examples instanceof ConllRelation[]))
    {
      ...
      System.err.println("Classifier 'OrganizationWorkFor(ConllRelation)' defined on line 20 of ER_Joint.lbj received '" + type + "' as input.");
      new Exception().printStackTrace();
      System.exit(1);
    }
