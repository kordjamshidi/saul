...
public class workLabel extends Classifier
{
  ...
  public String discreteValue(Object __example)
  {
    if (!(__example instanceof ConllRelation))
    {
      ...
      System.err.println("Classifier 'workLabel(ConllRelation)' defined on line 91 of LALModel.lbj received '" + type + "' as input.");
    ...
    {
      System.err.println("Classifier 'workLabel' defined on line 91 of LALModel.lbj produced '" + __cachedValue  + "' as a feature value, which is not allowable.");
      System.exit(1);
    }
