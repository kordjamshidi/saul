...
// 
...
import edu.illinois.cs.cogcomp.saulexamples.nlp.EntityMentionRelation.SL_SVM.iJLIS2.personLabel;
...
public class PersonClassifier extends SparseAveragedPerceptron
{
  ...
  static
  {
    _lcFilePath = PersonClassifier.class.getResource("PersonClassifier.lc");

    if (_lcFilePath == null)
    {
      System.err.println("ERROR: Can't locate PersonClassifier.lc in the class path.");
      System.exit(1);
    }

    _lexFilePath = PersonClassifier.class.getResource("PersonClassifier.lex");

    if (_lexFilePath == null)
    {
      System.err.println("ERROR: Can't locate PersonClassifier.lex in the class path.");
      System.exit(1);
    }
  }
  ...
  private static void loadInstance()
  {
    if (instance == null)
    {
      instance = (PersonClassifier) Learner.readLearner(_lcFilePath);
      instance.readLexiconOnDemand(_lexFilePath);
    }
  }

  public static Parser getParser() { return new edu.illinois.cs.cogcomp.lbjava.parse.ArrayFileParser("/home/kordjam/Downloads/mylbjtest/src/main/java/PersonClassifier.ex"); }
  public static Parser getTestParser() { return new edu.illinois.cs.cogcomp.lbjava.parse.ArrayFileParser("/home/kordjam/Downloads/mylbjtest/src/main/java/PersonClassifier.test.ex"); }
  ...
  private PersonClassifier(boolean b)
  {
    super(new Parameters());
    containingPackage = "";
    name = "PersonClassifier";
    setEncoding(null);
    setLabeler(new personLabel());
  ...
  {
    super("PersonClassifier");
    isClone = true;
  }

	public PersonClassifier(String modelPath, String lexiconPath) { this(new Parameters(), modelPath, lexiconPath); }

	public PersonClassifier(Parameters p, String modelPath, String lexiconPath) {
		super(p);
		try {
		...
		else if (IOUtilities.existsInClasspath(PersonClassifier.class, modelPath)) {
			readModel(IOUtilities.loadFromClasspath(PersonClassifier.class, modelPath));
			readLexiconOnDemand(IOUtilities.loadFromClasspath(PersonClassifier.class, lexiconPath));
		}
		else {
			containingPackage = "";
			name = "PersonClassifier";
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof ConllRawToken || example instanceof Object[]))
      {
        ...
        System.err.println("Classifier 'PersonClassifier(ConllRawToken)' defined on line 24 of LALModel.lbj received '" + type + "' as input.");
  ...
  public static void main(String[] args)
  {
    ...
    {
      System.err.println("usage: PersonClassifier \\");
    ...
    PersonClassifier classifier = new PersonClassifier();
  ...
  public int hashCode() { return "PersonClassifier".hashCode(); }
  public boolean equals(Object o) { return o instanceof PersonClassifier; }
