...
import edu.illinois.cs.cogcomp.saulexamples.nlp.BaseTypes.InclusionMatching;

/**
 * Created by Taher on 2016-12-28.
 */
public class XmlInclusionMatching extends InclusionMatching implements IXmlSpanMatching {
    @Override
