...
class MultiModalSpRLDataModelTests extends FlatSpec with Matchers {
  ...
  s"text features for '${sentences().head.getText}'" should "be correct." in {
    ...
    isTokenAnImageConcept(firstSentencePhrases(0)) should be("false")
    isTokenAnImageConcept(firstSentencePhrases(1)) should be("false")
    isTokenAnImageConcept(firstSentencePhrases(2)) should be("false")
    isTokenAnImageConcept(firstSentencePhrases(3)) should be("false")
    isTokenAnImageConcept(firstSentencePhrases(4)) should be("false")
    isTokenAnImageConcept(firstSentencePhrases(5)) should be("false")
    isTokenAnImageConcept(firstSentencePhrases(6)) should be("false")
    isTokenAnImageConcept(firstSentencePhrases(7)) should be("false")
    isTokenAnImageConcept(firstSentencePhrases(8)) should be("false")
    isTokenAnImageConcept(firstSentencePhrases(9)) should be("false")
    isTokenAnImageConcept(firstSentencePhrases(10)) should be("false")
    isTokenAnImageConcept(firstSentencePhrases(11)) should be("false")

    isTokenAnImageConcept(secondSentencePhrases(0)) should be("false")
    isTokenAnImageConcept(secondSentencePhrases(1)) should be("false")
    isTokenAnImageConcept(secondSentencePhrases(2)) should be("false")
    isTokenAnImageConcept(secondSentencePhrases(3)) should be("true")
    isTokenAnImageConcept(secondSentencePhrases(4)) should be("false")
    isTokenAnImageConcept(secondSentencePhrases(5)) should be("false")
    isTokenAnImageConcept(secondSentencePhrases(6)) should be("false")
    isTokenAnImageConcept(secondSentencePhrases(7)) should be("false")
    isTokenAnImageConcept(secondSentencePhrases(8)) should be("false")
  }
}
